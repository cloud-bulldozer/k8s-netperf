...
func main() {
	...
	rootCmd.Flags().BoolVar(&udnl2, "udnl2", false, "Create and use a UDN called 'udn-l2-primary' as primary network.")
	rootCmd.Flags().BoolVar(&udnl3, "udnl3", false, "Create and use a UDN called 'udn-l3-primary' as primary network.")
